...
const displayWordDetails = (word) => {
  ...
  detailsBox.innerHTML = `<div class="">
      ...
      <div class="">
        ...
        <div className="">${creatElements(word.synonyms)}</div>
      </div>`;
  ...
  words.forEach((word) => {
    ...
    card.innerHTML = `
          <div class="bg-white rounded-xl shadow-lg py-10 px-5 space-y-5 text-center">
            ...
            <div>
                <p class="text-2xl font-semibold font-bangla">"${word.meaning ? word.meaning : " অর্থ পাওয়া জাইনি"} / ${word.pronunciation ? word.pronunciation : "Pronunciation পাওয়া জাইনি"}"</p>
